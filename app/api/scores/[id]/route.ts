...
export async function GET(
  ...
  const response = NextResponse.json({
    ...
    title: data.title,
    producer: data.document?.producer || "www.ocarinana.com",
    lyricist: data.document?.lyricist || "",
    composer: data.document?.composer || "",
    additionalInfo: data.document?.additionalInfo || "",
